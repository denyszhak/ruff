...
impl<'db> Bindings<'db> {
        ...
        'db: 'a,
    {
        ...
        // TODO: This combines constructor specializations across a flat collection of bindings,
        // losing the original union/intersection structure within a constructor group. If
        // specialization inference becomes branch-sensitive, revisit this combine step.
